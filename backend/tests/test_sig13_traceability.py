...
class Sig13TraceabilityTests(unittest.TestCase):
    ...
    def test_fallback_issues_surface_sig13_first_with_intake_status(self) -> None:
        """Confirms intake lists SIG-13 first and keeps tracker status from the frozen snapshot."""
        ...
        # Keep the mega interesting ticket above the fold for demo operators.
        self.assertEqual(issues[0]["ticket"], "SIG-13")
