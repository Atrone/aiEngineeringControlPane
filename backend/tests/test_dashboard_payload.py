...
class DashboardPayloadTests(unittest.TestCase):
    ...
    def test_dashboard_payload_uses_dynamic_metric_and_summary_text(self) -> None:
        ...
        self.assertEqual(metrics_by_label["Active runs"]["value"], "6")
        self.assertEqual(metrics_by_label["Active runs"]["hint"], "0 running, 4 waiting for review")
        ...
        self.assertEqual(
            ...
            "Total runtime across 7 runs in this lobby",
        )
        ...
        self.assertEqual(
            ...
            [
                "Review 4 runs waiting in the approval inbox.",
