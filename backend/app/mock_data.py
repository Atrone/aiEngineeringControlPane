...
RUN_SUMMARIES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "repo": "web-app",
        "branch": "ai/sig-13-mega-interesting-ticket",
        "owner": "Maya",
        "agent": "impl-agent",
        "runtime": "00:00",
        "cost": "$0.00",
        "status": "Review",
        "risk": "Medium",
        "currentStep": "Review package ready for SIG-13 handoff",
        "summary": "Demo run for SIG-13: reviewer handoff with issue traceability preserved from In Progress.",
        "evidence": {
            "diff": [
                "Added review-handoff markdown export on the task detail implementation package panel.",
                "Seeded SIG-13 with a frozen Linear snapshot so intake and traceability stay aligned.",
            ],
            "tests": ["npm run lint", "npm run test -- --runInBand"],
            "commands": ["git status", "git diff --stat"],
            "rationale": [
                "Keeps Linear SIG-13 visible in the mission-control lobby while the run awaits approval.",
            ],
        },
        ...
        "_issueSnapshot": {
            ...
            "ticket": "SIG-13",
            "title": "mega interesting ticket",
            "description": "Linear ticket SIG-13 scopes the mega interesting ticket workflow.",
            "priority": "0",
            "status": "In Progress",
            "url": "https://linear.app/example/issue/SIG-13",
